    ...
    <div className="flex flex-col items-start gap-10 overflow-y-auto h-full">
      ...
      <Tabs className="mb-10">
        ...
        <TabPanel className="px-4">
          ...
          Informationen über dich und dein Verhalten, meist durch Websites, Apps
          und Social Media. Diese Daten können beinhalten, was du online suchst,
          welche Seiten du besuchst und welche Posts du likest. Die gesammelten
          Daten werden dann gespeichert, entweder lokal auf einem Gerät oder in
          der Cloud. Cloud-Speicherung bedeutet, dass deine Daten auf Servern im
          Internet gesichert werden, was praktisch, aber auch risikoreich sein
          kann, wenn diese Server nicht gut geschützt sind. Es ist wichtig zu
          wissen, wo und wie deine Daten gespeichert werden, um deren Sicherheit
          einschätzen zu können.
        </TabPanel>
        <TabPanel className="px-4">
          Datenverarbeitung bedeutet, dass gesammelte Daten analysiert und
          genutzt werden, um Muster zu erkennen, Entscheidungen zu treffen oder
          Inhalte anzupassen. Beispielsweise können Social Media-Plattformen
          deine Daten nutzen, um dir personalisierte Werbung anzuzeigen.
          Manchmal werden deine Daten auch an Dritte weitergegeben, etwa an
          Werbefirmen oder Partnerunternehmen, oft ohne dass du es direkt
          bemerkst. Das birgt Risiken, da du die Kontrolle über deine Daten
          verlierst. Achte darauf, welche Daten du preisgibst und überprüfe die
          Datenschutzrichtlinien der Dienste, die du nutzt.
        </TabPanel>
        <TabPanel className="px-4">
        ...
        <TabPanel className="px-4">
          ...
          Überlege dir gut, welche Informationen du online teilst und wer darauf
          zugreifen kann. Achte auf die Datenschutzeinstellungen deiner Social
          Media-Profile und nutze die Möglichkeiten, die
          Privatsphäre-Einstellungen zu konfigurieren. Denke daran, dass einmal
          geteilte Daten schwer zurückzuholen sind. Schütze deine Daten und
          respektiere auch die Daten anderer, indem du sie nicht unbedacht
          weitergibst.
        </TabPanel>
      </Tabs>
