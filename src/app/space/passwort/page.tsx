...
export default function Passwort() {
  return (
    <div className="flex flex-col max-w-[1100px] px-6 justify-start">
      ...
      <div className="flex flex-row space-x-6 sm:mt-8 lg:mt-2">
        <div className="flex flex-col relative justify-start items-start space-y-2 min-w-[300px] h-auto bg-module-blue rounded-xl mx-auto lg:p-5 p-2 sm:p-10 scale-95 lg:mb-6 mb-14">
          ...
          <svg
            ...
            className="absolute lg:bottom-0 lg:right-0 rounded-br-xl md:bottom-2 md:right-2 hidden lg:flex"
            width="179"
            height="161"
            viewBox="0 0 179 161"
            fill="none"
          ...
          <svg
            ...
            viewBox="0 0 163 103"
            fill="none"
            className="absolute bottom-2 right-2 scale-75 hidden lg:flex"
          >
            <path
