  ...
  return (
    <div className="h-full relative flex">
      ...
      <div className="relative w-full h-full flex justify-center items-center flex-col gap-10">
        <textarea
          className="w-full border-[1px] border-gray-200 rounded-xl resize-none h-1/3 outline-none py-4 px-6"
        ...
        <div className="flex flex-col justify-center items-center gap-10 h-full">
          ...
          <Robot
            expression="resting"
            className="w-48 h-48 hover:scale-110 transition-transform cursor-pointer duration-500"
            onClick={onClick}
          />
        </div>
      </div>
